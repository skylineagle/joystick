...
> = Required<DevicesRecord<Tautomation, Tconfiguration, Tinformation>> &
  BaseSystemFields<Texpand>;
export type ModelsResponse<Tparams = unknown, Texpand = unknown> = Required<
  ModelsRecord<Tparams>
> &
  BaseSystemFields<Texpand>;
...
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> &
  AuthSystemFields<Texpand>;
export type ActionLogsResponse<Texpand = unknown> = ActionLogsRecord &
  BaseSystemFields<Texpand>;
